  ...
  return (
    <div ref={elementRef} className={classes.Skills}>
      <div className={classes.TechLists}>
        ...
        >
          <h2>
            Python <img src={imageAssets.clickIcon} alt="clickHere" />
          </h2>
        ...
        >
          <h2>
            General <img src={imageAssets.clickIcon} alt="clickHere" />
          </h2>
          <p>
        ...
        >
          ...
          <p>
            Ubuntu 20.04, Windows 10 with GitBash, VSCode, Pycharm, Firefox,
            Chrome.
          </p>
        </div>
        <div></div>
