...
const Projects = props => {
  ...
  const [projects] = useState({
    ...
    squarePlayground: {
      ...
      An early build of this project was having major performance issues caused by large image file sizes and complicated logic. While in pursuit of a solution to the complicated logic, I was introduced to Big O notation which helped me to understand why and how to refactor the code.`,
    ...
    fitness: {
      ...
      whatILearned: `I learned the importance of not reinventing the wheel (Ignoring the irony of this being a copy of another app) when it came to data management.

      My initial approach to storing data was using the file system to read/write to a .txt file. I found this approach to be extremely cumbersome. In my search for a better solution I took the time to weight-up the different options and settled on using SQLite database. 
